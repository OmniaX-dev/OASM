...
namespace Omnia
{
    namespace oasm
    {
        ...
        {
            public:
                virtual OutputManager& print(String s) = 0;
                virtual OutputManager& print(_int32 i) = 0;
                virtual OutputManager& newLine(void) = 0;
                virtual OutputManager& tab(void) = 0;

                virtual std::vector<String> flush(void) { return std::vector<String>(); }
        };

        class InputManager
        {
            public:
                virtual InputManager& read(String& in) = 0; //TODO: make this always blocking
        };
        ...
        class StandardConsoleOutput : public OutputManager
        {
            public:
                ...
                inline virtual OutputManager& print(_int32 i) { std::cout << (_int32)i; return *this; }
        ...
        class BufferedOutput : public OutputManager
        {
            public:
                ...
                inline virtual OutputManager& print(_int32 i) { m_buffer.push_back(String().addInt(i)); return *this; }
        ...
        class TextFileOutput : public OutputManager
        {
            public:
                ...
                inline virtual OutputManager& print(_int32 i) { m_file << (_int32)i; return *this; }
        ...
        class IOReciever
        {
            public:
                ...
                inline InputManager* getInHandler(void) { return m_in; }
